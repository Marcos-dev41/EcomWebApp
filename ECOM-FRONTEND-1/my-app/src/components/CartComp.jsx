...
const {removeFromCart} = useCart()
  ...
  return (
    <div className='flex flex-row p-5 rounded-xl justify-between w-full items-center 2xl:max-w-[550px] h-30 border-2 m-5  shadow-sm'>
        ...
        <div className="flex  flex-col flex-start font-bold text-sm text-gray-900 justify-around ">
